document.addEventListener('DOMContentLoaded', function() {
    ...
    const addRepoButton = document.getElementById('add-repository');
    const modal = document.getElementById('add-repository-modal');
    ...
    form.addEventListener('submit', function(event) {
        ...
        const title = document.getElementById('repo-title').value;
        const description = document.getElementById('repo-description').value;
        const link = document.getElementById('repo-link').value;

        // Crie um novo objeto repository com os dados do formulário
        const repository = {
            name: title,
        ...
        // Adicione o novo repositório à lista de repositórios
